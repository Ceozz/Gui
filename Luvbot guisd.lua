...
FpsInput.FocusLost:Connect(function() wait(.1)
	if tonumber(FpsInput.Text) >= 460 then 
		game.StarterGui:SetCore("SendNotification",{Title ="Luvbot Gui",Text ="FPS can't be greater than 460",Duration =10}) 
	else 
...
LowGfx.MouseButton1Click:Connect(function() 
	game.StarterGui:SetCore("SendNotification",{Title ="Luvbot Gui",Text ="Might freeze game for couple seconds",Duration =10})
	wait(1)
